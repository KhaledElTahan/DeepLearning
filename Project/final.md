...
Please download the whole website-template folder, make your changes then submit the whole website-template folder with this exact folder hierarchy.  You're to make modifications **only** inside the **team-specific** folder, **never** make any changes out of it.
